...
<style>
    ...
    /* ARAMA KUTUSU (KÜÇÜK VE HAP ŞEKLİNDE) */
    .stTextInput { width: 300px; float: right; } /* Sağa yasla ve küçült */
...
# --- HEADER KISMI ---
c1, c2 = st.columns([1, 1]) # Yarı yarıya böl
with c1:
    st.markdown("""
...
with c2:
    # Arama kutusu tekrar sağa ve küçük hale getirildi
    # HTML değil, Python input kullanıyoruz ki filtreleme çalışsın
    col_spacer, col_search = st.columns([1, 2]) # Sağa itmek için boşluk
    with col_search:
...
with col_center:
    if st.session_state.selected_pos_name and not df.empty:
        ...
        # BURASI ÇOK ÖNEMLİ: HTML KODU SOLA YASLI (GİRİNTİSİZ) OLMALI
        html_code = f"""
<div class="main-card">
