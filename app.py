...
<style>
    ...
    .decision-pill {
        ...
        margin-top: -45px; margin-left: 25px; position: relative; z-index: 20;
...
with col_center:
    if st.session_state.selected_pos_name and not df.empty:
        ...
        # BURASI ÇOK ÖNEMLİ: HTML KODUNU SOLA YASLADIK
        html_code = f"""
<div class="main-card">
<div class="image-box">
